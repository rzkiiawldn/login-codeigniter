                            ...
                            <div class="p-5">
                                ...
                                <form class="user" action="<?= base_url('auth/index') ?>" method="post">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Masukan Email..." name="email" value="<?= set_value('email') ?>">
