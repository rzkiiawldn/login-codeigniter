...
<div class="row">
    <div class="col-lg table-responsive">
        ...
        <a href="" class="btn btn-<?= $warna['warna'] ?> mb-3" data-toggle="modal" data-target="#tambahSubMenuModal"><i class="fas fa-plus"></i> Tambah SubMenu</a>
                ...
                foreach ($dataSubMenu as $submenu) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url('menu/deleteSub/' . $submenu['id_sub']) ?>" class="badge badge-danger" onclick="return confirm('Apakah anda yakin ingin menghapus?')">hapus</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
            ...
            <form action="<?= base_url('menu/submenu') ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="" value="<?= set_value('judul') ?>" name="judul">
                    </div>
                    <div class="form-group">
    ...
    <div class="modal fade" id="editSubMenuModal<?= $submenu['id_sub'] ?>" tabindex="-1" role="dialog" aria-labelledby="editSubMenuModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('menu/editSub/' . $submenu['id_sub']) ?>" method="post">
                    <div class="modal-body">
                        <input type="hidden" name="id_sub" value="<?= $submenu['id_sub'] ?>">
                        <div class="form-group">
                            <label for="">Judul SubMenu</label>
                            <input type="text" class="form-control" placeholder="" value="<?= $submenu['judul'] ?>" name="judul">
                        </div>
                        <div class="form-group">
                            <label for="menu">Menu</label>
